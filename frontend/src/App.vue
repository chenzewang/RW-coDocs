<template>
  <a-layout id="components-layout-demo-top-side-2" style="height:100%">
    <a-layout-header id="header" class="header-bg-color">
      <div
        class="logo"
        style="width:200px;height:80px;margin-left:10px;margin-right:0"
      >
        <!-- <span
          class="icon-juzhentanyuansujiegou"
          style="font-size: 64px; "
        ></span> -->
        <img src="@/assets/logo2.png" class="logo-img" alt="" />
        <!-- <span class="test" style="font-size:20px">文档</span> -->
      </div>
      <a-menu
        theme="light"
...
@font-face {
  ...
  src: url("//at.alicdn.com/t/webfont_4c51zybezga.eot?#iefix")
      format("embedded-opentype"),
    /* IE6-IE8 */ url("//at.alicdn.com/t/webfont_4c51zybezga.woff2")
      format("woff2"),
    url("//at.alicdn.com/t/webfont_4c51zybezga.woff") format("woff"),
    /* chrome、firefox */ url("//at.alicdn.com/t/webfont_4c51zybezga.ttf")
      format("truetype"),
    /* chrome、firefox、opera、Safari, Android, iOS 4.2+*/
      url("//at.alicdn.com/t/webfont_4c51zybezga.svg#杨任东竹石体-Bold")
      format("svg"); /* iOS 4.1- */
}
