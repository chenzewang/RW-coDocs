<template>
  <div>
    ...
    <a-list
      :grid="{ gutter: 25, xs: 1, sm: 2, md: 4, lg: 4, xl: 6, xxl: 6 }"
      :data-source="data"
    >
    ...
    <div>
      <a-modal
        title="修改团队信息"
        :visible="modifyTeamVisible"
        @ok="modifyTeam"
        @cancel="cancelModify"
      >
        <template>
          <a-form-model
            :model="modifyTeamForm"
            :label-col="labelCol"
