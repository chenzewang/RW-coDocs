<template>
  <div>
    <div v-show="this.rightObj.doctype != 1">
      ...
      <a-row>
        ...
        <a-col span="18" align="right">
          <a-radio-group
            name="modify_right"
            v-model="rightObj.modify_right"
            :disabled="!rightObj.isleader"
          >
      ...
      <a-row>
        ...
        <a-col span="18" align="right">
          <a-radio-group
            name="modify_right"
            v-model="rightObj.discuss_right"
            :disabled="!rightObj.isleader"
          >
            <a-radio :value="true">有</a-radio>
            <a-radio :value="false">无</a-radio>
    ...
    <div>
      <a-divider>{{
        this.rightObj.doctype == 1 ? "协作者权限" : "非团队成员权限"
      }}</a-divider>
      <a-row>
        <a-col span="6" align="left">修改文档</a-col>
        <a-col span="18" align="right">
          <a-radio-group
            name="modify_right"
            v-model="rightObj.others_modify_right"
            :disabled="!rightObj.isleader"
          >
            <a-radio :value="true">有</a-radio>
            <a-radio :value="false">无</a-radio>
      ...
      <a-row>
        ...
        <a-col span="18" align="right">
          <a-radio-group
            name="modify_right"
            v-model="rightObj.others_share_right"
            :disabled="!rightObj.isleader"
          >
            <a-radio :value="true">有</a-radio>
            <a-radio :value="false">无</a-radio>
      ...
      <a-row>
        ...
        <a-col span="18" align="right">
          <a-radio-group
            name="modify_right"
            v-model="rightObj.others_discuss_right"
            :disabled="!rightObj.isleader"
          >
            <a-radio :value="true">有</a-radio>
            <a-radio :value="false">无</a-radio>
    ...
    <a-button
      type="default"
      style="float:left;margin-left:10%;margin-bottom:20px"
      @click="load_right(propRightObj)"
      :disabled="!rightObj.isleader"
      >重置</a-button
    >
    <a-button
      type="primary"
      style="float:right;margin-right:10%;margin-bottom:20px"
      @click="commit()"
      :disabled="!rightObj.isleader"
      >提交</a-button
    >
  ...
  watch: {
    ...
    propDocumentID: {
      handler(newVal) {
        ...
        axios
          .post(
            "http://localhost:5000/api/tell_current_doc_right/",
            formData,
            config
          )
          .then(function(response) {
            if (response) {
              ...
              _this.rightObj.others_modify_right =
                response.data.others_modify_right == 1;
              _this.rightObj.others_share_right =
                response.data.others_share_right == 1;
              _this.rightObj.others_discuss_right =
                response.data.others_discuss_right == 1;
  ...
  methods: {
    personalize() {
      ...
      if (this.rightObj.doctype == 1) {
        ...
        axios
          .post(
            "http://localhost:5000/api/set_document_private/",
            formData,
            config
          )
          .then(function(response) {
        ...
        if (this.rightObj.isleader) {
          ...
          axios
            .post(
              "http://localhost:5000/api/group_doc_to_personal/",
              formData,
              config
            )
            .then(function(response) {
    ...
    commit() {
      ...
      if (this.rightObj.doctype == 1) {
        ...
        formData.append(
          "others_share_right",
          this.rightObj.others_share_right ? 1 : 0
        );
        formData.append(
          "others_discuss_right",
          this.rightObj.others_discuss_right ? 1 : 0
        );
        formData.append(
          "others_modify_right",
          this.rightObj.others_modify_right ? 1 : 0
        );
        let config = {
          headers: {
            "Content-Type": "multipart/form-data",
        ...
        axios
          .post(
            "http://localhost:5000/api/modify_personal_doc_right/",
            formData,
            config
          )
          .then(function(response) {
        ...
        if (this.rightObj.isleader) {
          ...
          axios
            .post(
              "http://localhost:5000/api/modify_group_doc_right/",
              formData,
              config
            )
            .then(function(response) {
