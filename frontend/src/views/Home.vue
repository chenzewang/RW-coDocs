<template>
  <a-layout id="components-layout-demo-side" v-title data-title="日王文档主页">
    <a-layout-sider
    ...
    >
      <a-menu
        theme="light"
        :default-selected-keys="['sub1', 'recent-docs']"
        mode="inline"
        @select="handleSelect"
      >
        <a-sub-menu key="sub1">
        ...
        <a-sub-menu key="sub-team">
          ...
          <a-menu-item key="founded-team" @click="reload"
            >我创建的团队</a-menu-item
          >
          <a-menu-item key="joined-team" @click="reload"
            >我加入的团队</a-menu-item
          >
        </a-sub-menu>
